...
void badepause_fehler(char *User) {
    printf("+-------------------------------------------------------+\n");
    printf("|  Fehler                                           [X] |\n");
    printf("+-------------------------------------------------------+\n");
    printf("|                                                       |\n");
    printf("| [!]  Diese Badepause wird wegen eines ungültigen      |\n");
    printf("|      Vorgangs geschlossen.                            |\n");
    printf("|                                                       |\n");
    printf("|      * %s wird nun baden gehen.                  |\n", User);
    printf("|      * Nicht gespeicherte Schmutzstellen gehen verloren.|\n");
    printf("|                                                       |\n");
    printf("|                   [ Abbrechen ]  [ Details >> ]       |\n");
    printf("+-------------------------------------------------------+\n");
}
...
int main(void)
{
   ...
   if (Stunde == 17 && strcmp(Wochentag[Woche], "Samstag") == 0)
   {
      badepause_fehler(User);
   }
   else
   {
